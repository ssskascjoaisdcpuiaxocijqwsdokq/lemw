...
result_dir="experiment_results/ETTh2_${model_name}_${timestamp}"
mkdir -p $result_dir
...
echo "========================================" | tee -a $log_file
echo "AdaWaveNet ETTh2 实验开始" | tee -a $log_file
...
# 实验1: ETTh2 96->96
echo "" | tee -a $log_file
echo "开始实验1: ETTh2 96->96 预测..." | tee -a $log_file
echo "开始时间: $(date)" | tee -a $log_file
...
# 实验2: ETTh2 96->192
echo "" | tee -a $log_file
echo "开始实验2: ETTh2 96->192 预测..." | tee -a $log_file
echo "开始时间: $(date)" | tee -a $log_file
...
# 实验3: ETTh2 96->336
echo "" | tee -a $log_file
echo "开始实验3: ETTh2 96->336 预测..." | tee -a $log_file
echo "开始时间: $(date)" | tee -a $log_file
...
# 实验4: ETTh2 96->720
echo "" | tee -a $log_file
echo "开始实验4: ETTh2 96->720 预测..." | tee -a $log_file
echo "开始时间: $(date)" | tee -a $log_file
...
echo "" | tee -a $log_file
echo "========================================" | tee -a $log_file
echo "所有ETTh2实验完成!" | tee -a $log_file
