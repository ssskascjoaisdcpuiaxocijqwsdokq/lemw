...
def generate_summary(results_dir):
    ...
    with open(summary_file, 'w', encoding='utf-8') as f:
        f.write("Weather Dataset Experiment Results Summary\n")
        f.write("=========================================\n")
        ...
        f.write("- weather_96_96:  seq_len=96, pred_len=96\n")
        f.write("- weather_96_192: seq_len=96, pred_len=192\n")
        f.write("- weather_96_336: seq_len=96, pred_len=336\n")
        f.write("- weather_96_720: seq_len=96, pred_len=720\n")
        f.write(f"\nResults saved in: {results_dir}\n")
    
    print(f"实验汇总文件已生成: {summary_file}")
    return summary_file
