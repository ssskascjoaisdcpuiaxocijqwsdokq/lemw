...
class SimplePKIM1D(nn.Module):
    ...
    def __init__(self, channels: int, kernel_sizes: tuple = (3, 5, 7)):
        ...
        # 注意力机制
        self.attention = SimpleCAA1D(channels)
...
class OptimizedAdpWaveletBlock(nn.Module):
    ...
    def __init__(self, configs, input_size):
        ...
        # 简化的多尺度特征提取（移除HWD）
        self.feature_enhancer = SimplePKIM1D(configs.enc_in)
...
class Model(nn.Module):
    """
    ZABB_Optimized: 优化版本，移除有害模块，保留核心功能
    """
    ...
    def __init__(self, configs):
        ...
        for i in range(configs.lifting_levels):
            self.encoder_levels.add_module(
                ...
                OptimizedAdpWaveletBlock(configs, input_size)  # 使用优化版本
            )
            in_planes *= 1
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec, clusters):
        ...
        # Encoding with optimized wavelet blocks
