...
class LightweightEncoder(nn.Module):
    ...
    def forward(self, x, attn_mask=None):
        ...
        # 简单特征增强
        enhanced = self.feature_enhance(transformer_out)
        output = self.final_norm(transformer_out + enhanced)
...
class Model(nn.Module):
    """
    ZAAA_Final_Simplified: 简化版本，去除复杂模块，保持核心功能
    基于AdaWaveNet + 轻量级Transformer编码器
    """
